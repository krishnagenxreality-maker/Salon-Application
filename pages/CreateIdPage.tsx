...
const CreateIdPage: React.FC<CreateIdPageProps> = ({ onCreateId, onNavigateToLogin }) => {
        ...
        <div className="w-full min-h-screen bg-white flex items-center justify-center p-4 animate-fade-in">
            <div className="max-w-md w-full text-center">
                ...
                <form onSubmit={handleSubmit} className="mt-8 text-left space-y-6">
                    <div>
                        <label htmlFor="applicationNumber" className="text-sm font-medium text-gray-700">Application Number</label>
                        <input
