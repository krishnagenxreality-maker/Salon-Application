            ...
            {SALON_SERVICES.map((service) => (
                ...
                >
                    <div className="h-10 w-10 sm:h-12 sm:w-12 bg-light-grey dark:bg-gray-700 rounded-full flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-black dark:group-hover:bg-white transition-colors duration-300">
                        <service.icon className="w-5 h-5 sm:w-6 sm:h-6 text-black dark:text-white group-hover:text-white dark:group-hover:text-black transition-colors duration-300" />
                    </div>
                    <h3 className="text-base sm:text-lg font-bold text-black dark:text-white leading-tight">{service.title}</h3>
