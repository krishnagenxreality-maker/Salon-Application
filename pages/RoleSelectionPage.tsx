    ...
    <div className="w-full min-h-screen bg-white flex flex-col items-center justify-center p-4 animate-fade-in">
      ...
      <div className="grid md:grid-cols-2 gap-6 w-full max-w-2xl animate-slide-up" style={{ animationDelay: '0.2s' }}>
        ...
        <button
          ...
          className="group relative bg-white border border-gray-200 p-8 rounded-2xl text-left hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col items-center md:items-start"
        >
          <div className="h-16 w-16 bg-light-grey rounded-full flex items-center justify-center mb-6 group-hover:bg-black transition-colors duration-300">
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-black group-hover:text-white transition-colors duration-300">
        ...
        >
          <div className="h-16 w-16 bg-light-grey rounded-full flex items-center justify-center mb-6 group-hover:bg-black transition-colors duration-300">
             <UserCircleIcon className="w-8 h-8 text-black group-hover:text-white transition-colors duration-300" />
          </div>
