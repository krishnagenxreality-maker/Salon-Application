...
const AdminPage: React.FC<AdminPageProps> = ({ onSelectCandidate }) => {
    ...
    return (
        <div className="w-full min-h-screen bg-white pb-16 px-4 sm:px-6 md:px-8 lg:px-12 animate-fade-in">
             <div className="max-w-screen-xl mx-auto">
                ...
                <div className="mb-8 sm:mb-12 border-b border-gray-200 pb-6 sm:pb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-4">
                        <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-gray-100 rounded-full text-xs sm:text-sm font-semibold text-gray-600">
                ...
                <div className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
                    <h2 className="text-xl font-bold text-black mb-6 tracking-tight">Registered Candidates</h2>
                    
                    {isLoading ? (
                        <div className="text-center py-12 text-gray-500">Loading candidate data...</div>
                    ) : (
                    <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                        <div className="grid grid-cols-12 bg-gray-50 p-4 text-[10px] font-bold text-gray-500 uppercase tracking-widest border-b border-gray-200">
                        ...
                        <div className="divide-y divide-gray-100">
                            {users.length === 0 ? (
                                ...
                                users.map((user) => (
                                    ...
                                    >
                                        <div className="col-span-3 sm:col-span-2 text-xs font-mono font-semibold text-gray-500">
                                            #{user.id.slice(0,6)}
                                        </div>
                                        <div className="col-span-5 sm:col-span-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-sm sm:text-base font-semibold text-black">{user.name}</span>
                                            </div>
                                        </div>
